...
Ansible Controller is available link:https://{aap_controller_web_url}/[here].
...
link:https://{aap_controller_web_url}/#/jobs[Controller Jobs] tab shows you the history
...
link:https://{aap_controller_web_url}/#/templates[Controller Templates] tab
